...
namespace AspVue.Migrations
{
    ...
    [Migration("20190521203615_Orders")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AspVue.Data.Entities.AppRole", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("AspVue.Data.Entities.AppUser", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("AspVue.Data.Entities.Order", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("AspVue.Data.Entities.OrderItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.HasIndex("ProductId", "ColorId", "StorageId");
            ...
            modelBuilder.Entity("AspVue.Data.Entities.Order", b =>
                {
                    b.HasOne("AspVue.Data.Entities.AppUser", "User")
                        .WithMany("Orders")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.OwnsOne("AspVue.Data.Entities.Address", "DeliveryAddress", b1 =>
                        {
                            ...
                            b1.HasOne("AspVue.Data.Entities.Order")
                                .WithOne("DeliveryAddress")
                                .HasForeignKey("AspVue.Data.Entities.Address", "OrderId")
                                .OnDelete(DeleteBehavior.Cascade);
                        });
                });
            ...
            modelBuilder.Entity("AspVue.Data.Entities.OrderItem", b =>
                {
                    b.HasOne("AspVue.Data.Entities.Order")
                        .WithMany("Items")
                        .HasForeignKey("OrderId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("AspVue.Data.Entities.ProductVariant", "ProductVariant")
                        .WithMany()
                        .HasForeignKey("ProductId", "ColorId", "StorageId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<int>", b =>
                {
                    b.HasOne("AspVue.Data.Entities.AppRole")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<int>", b =>
                {
                    b.HasOne("AspVue.Data.Entities.AppUser")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
